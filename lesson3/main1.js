...
// for (let simpson of simpsons){
//     document.write(`<div>`)
//     document.write(`<h2 class="h2">${simpson.name} ${simpson.surname}. Age is - ${simpson.age}</h2>`)
//     document.write(`<p class="p">${simpson.info}</p>`)
//     document.write(`<img class="img1" src="${simpson.photo}" alt="">`)
//     document.write(`</div>`)
// }
//
...
//     document.write(`<div>`)
//     document.write(`<h3 class="product-title">${product.title}. Prise - ${product.price}</h3>`)
