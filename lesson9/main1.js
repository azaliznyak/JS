...
// //     divM.innerText=`${element.monthDuration}`;
// //     let divH=document.createElement('div');
// //     document.body.appendChild(divH);
// //     divH.innerText=`${element.hourDuration}`;
// //     wrap.append(divM,divH);
// //     wrap.style.display='flex';
// //     divM.style.width='20px';
// //     divH.style.width='80px';
// //
// //
// //
// //     for (let modulesEl of element.modules) {
// //         let li=document.createElement('li');
// //         document.body.appendChild(li);
// //         li.innerText=modulesEl
// //
// //     }
// //
// }